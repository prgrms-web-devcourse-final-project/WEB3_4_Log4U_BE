...
public class DiaryMarkerFixture {
	...
	public static GetDiaryMarkerResponse createDiaryMarker(Long id, String title, String thumbnailUrl, Long likeCount, Double lat, Double lon, LocalDateTime createdAt) {
		return new GetDiaryMarkerResponse(id, title, thumbnailUrl, likeCount, lat, lon, createdAt);
	}

	public static List<GetDiaryMarkerResponse> createDiaryMarkers() {
		return List.of(
	...
	public static GetDiaryMarkerResponse createDiaryMarker(Long id) {
