...
@EnableJpaRepositories(
	basePackages = {"com.example.log4u.domain.map.repository"},
...
public class PostgreSqlConfig {
	...
	public DataSource postgresqlDataSource(
		...
		@Qualifier("postgresqlHikariConfig") HikariConfig hikariConfig
	) {
	...
	public PlatformTransactionManager postgresqlTransactionManager(@Qualifier("postgresqlEntityManagerFactory") LocalContainerEntityManagerFactoryBean postgresqlEmf) {
